...
<table>
  <tr>
    <td width="50%" valign="top"><strong><a href="docs/source-notes.md#included-public-cases">スケッチ誘導の落書き</a></strong><br><img src="assets/media/005-doodles.gif" alt="Sketch-guided doodles example"></td>
    <td width="50%" valign="top"><strong><a href="docs/source-notes.md#included-public-cases">スケッチ誘導の色ブロック</a></strong><br><img src="assets/media/006-color-block.gif" alt="Sketch-guided color block example"></td>
  </tr>
  <tr>
    <td width="50%" valign="top"><strong><a href="docs/source-notes.md#included-public-cases">スケッチ誘導の線</a></strong><br><img src="assets/media/007-lines.gif" alt="Sketch-guided lines example"></td>
    <td width="50%" valign="top"><strong><a href="docs/source-notes.md#included-public-cases">シンプルスケッチ制御</a></strong><br><img src="assets/media/008-simple-sketches.gif" alt="Simple sketch control example"></td>
  </tr>
  <tr>
