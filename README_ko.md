...
### Case 1: [대상 편집을 위한 영역 박스 객체 설명](docs/source-notes.md#included-public-cases)
...
### Case 2: [격자형 장면의 앵커 위치 편집](docs/source-notes.md#included-public-cases)
...
### Case 3: [다중 참조 정물 구성](docs/source-notes.md#included-public-cases)
...
<table>
  <tr>
    <td width="50%" valign="top"><strong><a href="docs/source-notes.md#included-public-cases">스케치 기반 낙서</a></strong><br><img src="assets/media/005-doodles.gif" alt="스케치 기반 낙서 example"></td>
    <td width="50%" valign="top"><strong><a href="docs/source-notes.md#included-public-cases">스케치 기반 색상 블록</a></strong><br><img src="assets/media/006-color-block.gif" alt="스케치 기반 색상 블록 example"></td>
  </tr>
  <tr>
    <td width="50%" valign="top"><strong><a href="docs/source-notes.md#included-public-cases">스케치 기반 선</a></strong><br><img src="assets/media/007-lines.gif" alt="스케치 기반 선 example"></td>
    <td width="50%" valign="top"><strong><a href="docs/source-notes.md#included-public-cases">간단한 스케치 제어</a></strong><br><img src="assets/media/008-simple-sketches.gif" alt="간단한 스케치 제어 example"></td>
  </tr>
  <tr>
    <td width="50%" valign="top"><strong><a href="docs/source-notes.md#included-public-cases">레이어 분리 예시</a></strong><br><img src="assets/media/017-Feishu-Docs-Image.png" alt="레이어 분리 예시"></td>
    <td width="50%" valign="top"><strong><a href="docs/source-notes.md#included-public-cases">레이어 분리 변형</a></strong><br><img src="assets/media/018-Feishu-Docs-Image.png" alt="레이어 분리 변형"></td>
  </tr>
  <tr>
    <td width="50%" valign="top"><strong><a href="docs/source-notes.md#included-public-cases">영화적 테니스 유리 파편</a></strong><br><img src="assets/media/020-Cinematic-narrative-tennis-glass-shatter.png" alt="영화적 테니스 유리 파편"></td>
    <td width="50%" valign="top"><strong><a href="docs/source-notes.md#included-public-cases">영화적 복싱 액션</a></strong><br><img src="assets/media/021-Cinematic-narrative-action-boxing.png" alt="영화적 복싱 액션"></td>
  </tr>
  <tr>
    <td width="50%" valign="top"><strong><a href="docs/source-notes.md#included-public-cases">아랍어와 영어 텍스트 렌더링</a></strong><br><img src="assets/media/025-Welcome.png" alt="Arabic and English welcome text rendering"></td>
    <td width="50%" valign="top"><strong><a href="docs/source-notes.md#included-public-cases">한국어 텍스트 렌더링</a></strong><br><img src="assets/media/026-24-Open-24-hours.png" alt="Korean open 24 hours text rendering"></td>
  </tr>
</table>
