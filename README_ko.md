...
프롬프트와 입력 텍스트는 사용 사례 분류와 분리해 둡니다.
...
이 저장소는 2026년 7월 8일에 내보낸 Seedream 5.0 Pro 공식 출시 자료와 사용 사례 갤러리 및 프롬프트 라이브러리에 인용된 공개 커뮤니티 게시물을 바탕으로 만들어졌습니다.
