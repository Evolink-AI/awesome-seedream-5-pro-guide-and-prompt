...
<details>
<summary>Prompt/input excerpt</summary>
...
Prompt and input text stays separate from the use case taxonomy. Use case categories describe the user task; tags describe attributes; prompt snippets are copied only when the source package contains extractable text.
