...
Estos 35 casos de la comunidad están agrupados por tarea del usuario y propósito de salida. Las etiquetas indican atributos secundarios como comparación de modelos, prompt disponible, entrada de imagen y salida multiimagen.

Número de casos de uso: **35**.
...
Etiquetas: `image-input` `multi-image` `prompt-available` `tutorial`
...
Etiquetas: `multi-image` `prompt-available` `tutorial`
...
Etiquetas: `image-input` `multi-image` `prompt-available`
...
### Diseño de producto, interfaz y póster
...
Etiquetas: `multi-image` `prompt-available`
...
### Visuales cinematográficos, personajes y estilo

Número de casos de uso: **10**.
...
### Arte conceptual, entorno y worldbuilding
...
Etiquetas: `capability-sampling` `model-comparison` `multi-image` `prompt-available`
...
Etiquetas: `model-comparison` `multi-image` `prompt-available`
...
Etiquetas: `image-input` `model-comparison` `multi-image` `prompt-available`
...
Etiquetas: `model-comparison` `prompt-available`
